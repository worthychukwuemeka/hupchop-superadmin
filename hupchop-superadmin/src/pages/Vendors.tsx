...
const Vendors: React.FC = () => {
  ...
  const rows: TableRowProps[] = [
    {
      id: 1,
      avatar: './assets/images/vendors/1.jpg',
      customerName: 'KFC',
    ...
    {
      id: 2,
      avatar: './assets/images/vendors/2.jpeg',
      customerName: 'Drumstix',
      address: 'Peace Villa & Suites, Mpape',
      phoneNumber: '+234 987 654 3210',
      email: 'info@drumstix.com',
    ...
    {
      id: 4,
      avatar: './assets/images/vendors/4.png',
      customerName: 'Chicken Republic',
          ...
          <div className="page-header">
            <div className="page-header-left d-flex align-items-center">
              <div className="page-header-title">
                <h5 className="m-b-10">Vendors</h5> {/* Updated to "Vendors" */}
              </div>
              <ul className="breadcrumb">
                <li className="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                <li className="breadcrumb-item">Vendors</li> {/* Updated to "Vendors" */}
              </ul>
            </div>
                              ...
                              <td>
                                <div className="ms-3 d-flex gap-2 align-items-center">
                                  ...
                                  <div className="hstack gap-2 justify-content-end">
                                    <Link to="/vendor-details" className="avatar-text avatar-md text-primary me-2">
